...
def draw_delta_plots(data, pnum):
    ...
    plt.suptitle(f'Delta Plots for Participant {pnum}', fontsize=16)
    ...
    plt.rcParams['axes.grid.color'] = 'lightgray'
    plt.rcParams['axes.grid.linestyle'] = '--'
    plt.rcParams['axes.grid.linewidth'] = 0.5
...
if __name__ == "__main__":
    ...
    # Delta plot analysis
    delta_data = read_data(data_path, prepare_for='delta plots', display=False)
